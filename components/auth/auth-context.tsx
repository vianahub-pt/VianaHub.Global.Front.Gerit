...
import { DEFAULT_LANGUAGE, normalizeLanguageTag } from "@/lib/language";

const AUTH_STORAGE_KEY = "gerit.auth.session.v1";
...
function getPreferredRequestLanguage() {
  ...
  return normalizeLanguageTag(window.localStorage.getItem("language"));
}
