                        ...
                        [
                          {
                            ...
                            description: t("preferences.appearance.light.description"),
                          },
                          {
                            key: "dark",
                            icon: MoonStar,
                            title: t("preferences.appearance.dark.title"),
                            description: t("preferences.appearance.dark.description"),
                          },
                        ] as const
                      ).map((option) => {
                        const Icon = option.icon;
                        const active = preferences.state.appearance === option.key;
                        ...
                        <div className="w-full">
                          ...
                          <div className="mt-5">
                            <PreferenceSelect
                              ...
                              onChange={(value) => {
                                preferences.setLocale(value as PreferenceLocale);
                              }}
                            />
                          </div>
                        </div>
                  ...
                  <section className="rounded-[1.75rem] border border-[#d7e0e5] bg-white p-5 dark:border-[#17313a] dark:bg-[#0a171e]">
                    ...
                    <div className="mt-6 grid gap-4 md:grid-cols-2">
                      ...
                      <PreferenceSelect
                        ...
                        onChange={(value) => {
                          preferences.setDateFormat(value as DateFormatPreference);
                        }}
                      />
                      <PreferenceSelect
                        ...
                        onChange={(value) => {
                          preferences.setTimeFormat(value as TimeFormatPreference);
                        }}
                      />
                      <PreferenceSelect
